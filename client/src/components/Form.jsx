  ...
  return (
    <>
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 mt-4 md:mt-0">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1">
              <div
                className={`flex relative items-center border-b-2 ${
                  errors.price ? "border-red-500" : "focus-within:border-black"
                }`}
              >
          ...
          <div className="flex flex-col gap-5">
            {images.length > 0 ? (
              ...
              <>
                ...
                <label
                  htmlFor="thumbnail"
                  className={`relative aspect-4/3 flex w-full items-center justify-center border-2 border-dashed rounded-xl cursor-pointer overflow-hidden peer-focus-visible:border-amber-600 ${
            ...
            {errors.images && (
              <p className="text-red-500 -mt-3.5 -mb-1.5 text-sm">
                {errors.images}
              </p>
            )}
            ...
            <div className="self-center flex gap-3 flex-wrap">
              {images.slice(1).map((img, idx) => (
                <div
                  key={idx}
                  className="relative w-18 h-18 xl:w-20 xl:h-20 border rounded-lg overflow-hidden"
                >
                  <img
                    src={img.preview}
              ...
              {images.length < MAX_IMAGES && (
                <>
                  ...
                  <label
                    htmlFor="add-img"
                    className="w-18 h-18 xl:w-20 xl:h-20 border-2 border-dashed peer-focus-visible:border-amber-600 rounded-lg flex items-center justify-center cursor-pointer"
                  >
                    <Plus size={24} />
                  </label>
                </>
        ...
        {mode === "create" ? (
          ...
          <div className="mt-6 flex gap-4">
            <button
              ...
              className="w-full border-2 border-gray-300 text-gray-700 py-2.5 rounded-lg text-lg font-semibold hover:bg-gray-100"
            >
              Cancel Changes
            </button>
            ...
            <button
              type="submit"
              className="w-full bg-black text-white py-2.5 rounded-lg text-lg font-semibold"
            >
              Save Changes
            </button>
          </div>
      ...
      <DialogBox
        open={showDialog}
        title="Save Changes?"
        description="Do you want to save the changes you’ve made?"
        confirmText="Save"
        cancelText="Discard"
